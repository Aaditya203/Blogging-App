...
export type LikeWhereUniqueInput = Prisma.AtLeast<{
  post_id_user_id?: Prisma.LikePost_idUser_idCompoundUniqueInput
  AND?: Prisma.LikeWhereInput | Prisma.LikeWhereInput[]
  OR?: Prisma.LikeWhereInput[]
  NOT?: Prisma.LikeWhereInput | Prisma.LikeWhereInput[]
  post_id?: Prisma.StringFilter<"Like"> | string
...
export type LikeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"post_id" | "user_id" | "created_at", ExtArgs["result"]["like"]>
...
export interface LikeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const likeWithPost_idOnly = await prisma.like.findMany({ select: { post_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Likes and only return the `post_id`
   * const likeWithPost_idOnly = await prisma.like.createManyAndReturn({
   *   select: { post_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Likes and only return the `post_id`
   * const likeWithPost_idOnly = await prisma.like.updateManyAndReturn({
   *   select: { post_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
